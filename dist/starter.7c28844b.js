...
},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./model.js":"cfHEn","./view/recipeView.js":"6f9ti","./view/searchView.js":"i0GJd","./view/resultView.js":"4TAyj","./view/paginationView.js":"3jGje","./view/bookmarkView.js":"gPnhN","./view/addRecipeView.js":"iyrcn","./config.js":"7c2aR"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
},{}],"cfHEn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const loadRecipe = async function(id) {
    try {
        const recipeData = await (0, _helper.AJAX)(`${(0, _config.API_URL)}/${id}?key=${(0, _config.KEY)}`);
        ...
        console.error(`${err}\u{26A1}\u{26A1}`);
        throw err;
    }
};
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        (0, _helper.AJAX)(`${(0, _config.API_URL)}?key=${(0, _config.KEY)}`, recipe);
        console.log(recipe);
...
},{"./config":"7c2aR","./helper":"zTDDW","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7c2aR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = 'f2cd8b66-86ca-4b0f-b1c0-d2d5ed7b1031';
const MODAL_CLOSE_SEC = 2.5;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"zTDDW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const AJAX = async function(url, uploadData) {
 ...
 //     const recipeApi = await Promise.race([fetchPro, timeout(TIMEOUT_SEC)]);
 //     const recipeData = await recipeApi.json();
 //     console.log(recipeData);
 //     if (!recipeApi.ok)
 //       throw new Error(`${recipeData.message} ${recipeApi.status}`);
 //     return recipeData;
 //   } catch (err) {
 //     throw err;
 //   }
...
},{"./config":"7c2aR","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6f9ti":[function(require,module,exports,__globalThis) {
// import icon
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = 'we dont have that recipe.Try another one';
    _message = '';
...
},{"url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./view":"3KKrH"}],"apwnT":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("icons.3eb43249.svg") + "?" + Date.now();

},{}],"3KKrH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"i0GJd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4TAyj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"3KKrH","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView":"2SanZ"}],"2SanZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
      ...
      <li class="preview">
        <a class="preview__link preview__link" href="#${this._data.id}">
          ...
          <div class="preview__data">
            ...
            <p class="${this._data.publisher}">The Pioneer Woman</p>
...
},{"./view":"3KKrH","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3jGje":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (currentPage === 1 && numPages > 1) return this._generateMarkupButton(currentPage, 'next');
        // Last page
        if (currentPage === numPages && numPages > 1) return this._generateMarkupButton(currentPage, 'prev');
        // Other page
        if (currentPage < numPages) return this._generateMarkupButton(currentPage, 'prev') + this._generateMarkupButton(currentPage, 'next');
...
},{"./view":"3KKrH","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gPnhN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"3KKrH","url:../../img/icons.svg":"apwnT","./previewView":"2SanZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iyrcn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"3KKrH","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3cF9g","dGopa"], "dGopa", "parcelRequire041d", {}, "./", "/")
